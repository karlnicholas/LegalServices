...
export default class StatuteNode extends React.Component {
	...
	getSection(entry) {
	    if ( entry.statutesBaseClass.statuteRange.sNumber != null && entry.statutesBaseClass.statuteRange.eNumber != null) {
	    	return (<div class='reference col-sm-2'>§§ {entry.statutesBaseClass.statuteRange.sNumber.sectionNumber} - {entry.statutesBaseClass.statuteRange.eNumber.sectionNumber}</div> );
	    } else if ( entry.statutesBaseClass.statuteRange.sNumber != null && entry.statutesBaseClass.statuteRange.eNumber == null) {
	    	return (<div class='reference col-sm-2'>§§ {entry.statutesBaseClass.statuteRange.sNumber.sectionNumber}</div>);
	    } else if ( entry.statutesBaseClass.statuteRange.sNumber == null && entry.statutesBaseClass.statuteRange.eNumber != null) {
	    	return (<div class='reference col-sm-2'>§§ {entry.statutesBaseClass.statuteRange.eNumber.sectionNumber}</div>);
	    } else if ( entry.statutesBaseClass.statuteRange.sNumber == null && entry.statutesBaseClass.statuteRange.eNumber == null) {
	    	return (<div class='reference col-sm-2'></div>);
	    }
	}
