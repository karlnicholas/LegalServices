...
import com.github.karlnicholas.legalservices.gsearch.util.FacetUtils;
import com.github.karlnicholas.legalservices.gsearch.viewmodel.*;
import com.github.karlnicholas.legalservices.gsearch.viewmodel.ViewModel.STATES;
...
//	private StatutesTitles[] statutesTitles; 
	...
	private com.github.karlnicholas.legalservices.gsearch.util.Highlighter myHighlighter;

	// This is meant to be put into an application scope
	// after instantiation .. 
	public GSearch(ReactiveStatuteService reactiveStatutesService) throws IOException {
//		statutesTitles = parserInterface.getStatutesTitles();
		myHighlighter = new com.github.karlnicholas.legalservices.gsearch.util.Highlighter();
