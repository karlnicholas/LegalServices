...
import com.github.karlnicholas.legalservices.slipopinion.dao.OpinionBaseDao;
import com.github.karlnicholas.legalservices.slipopinion.dao.StatuteCitationDao;
import com.github.karlnicholas.legalservices.slipopinion.dao.SlipOpinionDao;
import com.github.karlnicholas.legalservices.slipopinion.dao.SlipPropertiesDao;
import com.github.karlnicholas.legalservices.slipopinion.model.SlipOpinion;
import com.github.karlnicholas.legalservices.slipopinion.model.SlipProperties;
...
//	}
	...
	public List<OpinionKey> updateDatabase(OpinionScraperInterface caseScraper, StatuteService statutesService) throws SQLException {
...
//			processAndPersistCases(onlineOpinions, caseScraper);
	...
	private void processAndPersistCases(List<SlipOpinion> slipOpinions, OpinionScraperInterface opinionScraper, StatuteService statutesService) throws SQLException {
