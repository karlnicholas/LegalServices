...
public class OpinionViewLoad {
	...
	@Async
	public void load(OpinionViewData opinionViewData, StatuteService statutesService) {
...
//			logger.info("load failed: " + ex.getCause().getMessage());
	...
	public void loadNewOpinions(OpinionViewData opinionViewData, List<OpinionKey> opinionKeys, StatuteService statutesService) {
		try {
	...
	private void buildOpinionViews(OpinionViewData opinionViewData, StatuteService statutesService) {
...
//		buildListedOpinionViews(opinionViewData, opinions, statutesService);
	...
	private void buildNewOpinionViews(OpinionViewData opinionViewData, List<OpinionKey> opinionKeys, StatuteService statutesService) {
