...
public class CourtListenerOpinionSave implements ParsedOpinion {
    ...
    public CourtListenerOpinionSave() {}
    public CourtListenerOpinionSave(CourtListenerClusterSave CourtListenerClusterSave) {
        // http://www.courtlistener.com/api/rest/v3/clusters/1361768/
    	id = Long.valueOf(pattern.split(CourtListenerClusterSave.getResource_uri())[7]);
    	clusterSource = CourtListenerClusterSave.getSource();
    	Calendar cal = Calendar.getInstance();
    	cal.setTime(CourtListenerClusterSave.getDate_filed());
    	try { 
    		dateFiled = LocalDate.parse(format.format(CourtListenerClusterSave.getDate_filed()));
...
//    		throw ex;
		...
		String citeOne = CourtListenerClusterSave.getState_cite_one().replace(". ", "."); 
		String citeTwo = CourtListenerClusterSave.getState_cite_two().replace(". ", "."); 
		String citeThree = CourtListenerClusterSave.getState_cite_three().replace(". ", ".");
...
*/
		caseName = CourtListenerClusterSave.getCase_name();
		fullCaseName = CourtListenerClusterSave.getCase_name_full();
		shortCaseName = CourtListenerClusterSave.getCase_name_short();
	}
	//
	public Long getId() {
		return id;
