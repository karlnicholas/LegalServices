...
public class CasetextOpinion implements ParsedOpinion {
	private Long id;
    ...
    public CasetextOpinion(Long id, String caseName, LocalDate dateFiled, String citation, Element opinionElement) {
    	this.id = id;
