...
create table caselistentry(id varchar(32), filename varchar(31), fileextension varchar(7), title varchar(137), opiniondate date, posteddate date, court varchar(255), searchurl varchar(128), status varchar(15) not null, primary key (id)) engine=InnoDB;
